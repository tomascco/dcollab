...
class DrawingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drawing" do
    assert_difference("Drawing.count") do
      post drawings_url, params: { drawing: { height: @drawing.height, name: @drawing.name, objects: @drawing.objects, width: @drawing.width } }
    end
  ...
  test "should update drawing" do
    patch drawing_url(@drawing), params: { drawing: { height: @drawing.height, name: @drawing.name, objects: @drawing.objects, width: @drawing.width } }
